...
public class lichSuController {
    ...
    public String showHistory(HttpServletRequest request, ModelMap model) {
        ...
        List<DonHangEntity> donHangChoXacNhanList = donHangFacade.layDonHangCuaUserTheoTrangThai(user.getMaNd(), 1);
        List<DonHangEntity> donHangDangGiaoList = donHangFacade.layDonHangCuaUserTheoTrangThai(user.getMaNd(), 2);
        List<DonHangEntity> donHangThanhCongList = donHangFacade.layDonHangCuaUserTheoTrangThai(user.getMaNd(), 3);
        List<DonHangEntity> donHangDaHuyList = donHangFacade.layDonHangCuaUserTheoTrangThai(user.getMaNd(), 0);

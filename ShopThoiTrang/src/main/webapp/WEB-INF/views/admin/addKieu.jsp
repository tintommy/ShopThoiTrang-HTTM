      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Thêm kiểu mới</h2>
              </div>
            </div>
            <f:form action="admin/brands/addKieu.htm" class="tm-edit-product-form" modelAttribute="brandForm" method="POST">
            <div class="row tm-edit-product-row">            
              <div class="col-xl-12 col-lg-12 col-md-12">                
                
                	<div class="form-group mb-3" style="display: none;">
    				    <label for="name">Mã kiểu</label>
    				    <f:input id="maKieu" path="maKieu" type="text" class="form-control validate" required="true" />    				    
    				</div>
    				<div class="form-group mb-3">
    				    <label for="name">Tên kiểu</label>
    				    <f:input id="nameKieu" type="text" path="tenKieu" class="form-control validate" required="true" />
    				</div>
    				
    				
    				<div class="form-group mb-3">
	    				    <label for="category">Kiểu thuộc loại</label>
          ...
          <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase" name="add">Thêm Kiểu</button>
          </div>  
          </div>

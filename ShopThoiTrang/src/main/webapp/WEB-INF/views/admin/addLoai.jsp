      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Thêm loại mới</h2>
              </div>
            </div>
            <f:form action="admin/brands/addLoai.htm" class="tm-edit-product-form" modelAttribute="brandForm" method="POST">
            <div class="row tm-edit-product-row">            
              <div class="col-xl-12 col-lg-12 col-md-12">                
                
                	<%-- <div class="form-group mb-3" style="display: none;">
    				    <label for="name">Mã loại</label>
    				    <f:input id="maLoai" path="maLoai" type="text" class="form-control validate" required="true" />    				    
    				</div> --%>
    				<div class="form-group mb-3">
    				    <label for="name">Tên loại</label>
    				    <f:input id="nameLoai" path="tenLoai" type="text" class="form-control validate" required="true" />
    				</div>
          ...
          <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase" name="add">Thêm loại</button>
          </div>  
          </div>
